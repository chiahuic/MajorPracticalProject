  ...
  while (choice != 0) {
    ...
    switch (choice) {
      ...
      case 2:  // if choice is euqal to 2, the management should display the
        ...
        Show_menu();
        break;
      case 3:  // if choice is euqal to 3, the management should delete the
               // information of employees
        break;
      case 4:  // if choice is euqal to 4, the management should modify the
               // information of employees
        break;
      case 5:  // if choice is euqal to 5, the management should search the
               // information of employees
        break;
